...
/// Element e of type xs:string.
    char*                                e                              1;	///< Required element.
...
/// Element outorder of type xs:string.
    char*                                outorder                       1;	///< Required element.
/// Element gapopen of type xs:float.
    float                                gapopen                        1;	///< Required element.
/// Element gapextend of type xs:float.
    float                                gapextend                      1;	///< Required element.
};
...
//gsoap ns1  service port:	http://soap.g-language.org/kbws/kbws.cgi 
...
@section KBWSSoapBinding_ports Endpoints of Binding  "KBWSSoapBinding"
  - http://soap.g-language.org/kbws/kbws.cgi
...
/******************************************************************************\
 *                                                                            *
 * ns1__map2PathwayProjector                                                  *
 *                                                                            *
\******************************************************************************/


/// Operation "ns1__map2PathwayProjector" of service binding "KBWSSoapBinding"
...
Operation details:
  ...
  - SOAP RPC encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"
  - SOAP action="http://soap.g-language.org/KBWS#map2PathwayProjector"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call_ns1__map2PathwayProjector(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // request parameters:
...
//gsoap ns1  service method-style:	map2PathwayProjector rpc
//gsoap ns1  service method-encoding:	map2PathwayProjector http://schemas.xmlsoap.org/soap/encoding/
//gsoap ns1  service method-action:	map2PathwayProjector http://soap.g-language.org/KBWS#map2PathwayProjector
int ns1__map2PathwayProjector(
    char*                               _in0,	///< Request parameter
    char*                              *_jobid	///< Response parameter
);
